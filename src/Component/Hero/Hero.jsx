  ...
  return (
    ...
    <div className="hero">
      <div className="hero-content">
        <h1>I'm Sathya, a passionate  <span>Full Stack Developer</span>
        </h1>
        <p>
        ...
        <a href="https://www.linkedin.com/in/sathya-m1701/" id="linkedin"><i class='bx bxl-linkedin'></i></a>
            ...
            <div className="hero-resume">
              <a href={ cv } download>My resume </a></div>
        </div>
      </div>
      <div className="profile">
        <img className="profile-img" src="./image/profile1.JPG" alt="profile" />
      </div>
      </div>
      </div>
